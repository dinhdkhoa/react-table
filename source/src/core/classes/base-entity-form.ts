...
export type onChangeFun<TEnity extends FieldValues = FieldValues> = (
  form: UseFormReturn<TEnity>,
  fieldName: string | undefined,
  value: any,
  formGetValues: TEnity
) => void
export type onBlurFun<TEnity extends FieldValues = FieldValues> = (
  form: UseFormReturn<TEnity>,
  fieldName: string | undefined,
  value: any,
  formGetValues: TEnity
...
export interface IBaseEntityForm<TEntity extends FieldValues>
  extends IBaseData<TEntity>,
