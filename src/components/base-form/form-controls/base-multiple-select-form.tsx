...
type BaseMultipleSelectVariantsProps = VariantProps<
  typeof MultipleSelectVariants
>

type BaseMultipleSelectProps<TEntity extends FieldValues = FieldValues> =
  BaseFormFieldPropsType<TEntity> &
    SharedVariantProps &
    BaseMultipleSelectVariantsProps

type BaseMultipleSelectItemsProps<
...
>(
  ...
  const { placeholder, label, disableFn, selectOption, validate } = rhf[
    field.name
